...
- Going Long adds 20, 50, 50, 50, then 100 to its target across rounds 1-5. Predictions are judged from the current round's scores after all Going Long and Big Short target adjustments are applied. The Collector starts with six discards, awards 20, 80, 150, 300, then 400 for its first five unique hand types, and shows the collected hand types at the player's seat.
- The Dice uses the higher of the fully effect-adjusted hand multiplier and the player's highest roll that round. Its outcomes are x3/x4/x5/x6/x7/x8/x10/x12/x15/x20 at 3%/6%/10%/20%/21.5%/20%/10.5%/5.5%/2.5%/1%. Specified reroll and mirror effects permanently add dice.
