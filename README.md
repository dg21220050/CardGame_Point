...
- The Giant starts with 3,300 total score and loses the greater of 1.3 times the lowest non-Giant round score or 50% of the highest non-Giant round score after each round. Its AOE deducts 20% of its bare hand score from every non-Giant player's total. Smash then deducts another 20% from every non-Giant player whose round score is lower than the Giant's bare hand score. Once per game, Defense Stance reduces that round's Giant burden by 80%, 70%, 60%, 50%, or 40% in rounds 1-5.
- The Big Short and Going Long predict the lowest and highest current-round scorer without changing the target's score. Their success counters are cumulative rather than consecutive; accumulated successes grant the existing 0, 50, 100, 300, then 500 bonus progression. The Collector starts with six discards, awards 20, 80, 150, 300, then 400 for its first five unique hand types, and shows the collected hand types at the player's seat.
- The Dice replaces the hand type's base multiplier with the player's highest roll, then adds all active effect multiplier bonuses. Its outcomes are x3/x4/x5/x6/x7/x8/x10/x12/x15/x20 at 2.5%/5%/8.5%/20%/21%/20%/13%/6%/3%/1%. Specified reroll and mirror effects permanently add dice.
...
- Tomato King, Tomato Shooter, and Tempered Tomato multiply their count bonus by the lower of the played hand's natural multiplier and 1.
